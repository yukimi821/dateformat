...
const formats = {
  ...
  W: (d) => ((d) => {
      ...
      if (W === lastWeekNumber) {
        return module.exports.formats.N(new Date(d.getFullYear() - 1, 11, 31)) < 4 ? 1 : lastWeekNumber;
      }
      return W;
  ...
  o: (d) => ((d) => {
      const W = new Number(module.exports.formats.W(d));
      const n = new Number(module.exports.formats.n(d));
      if (W === 1 && n === 12) {
